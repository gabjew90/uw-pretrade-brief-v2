...
function Ladder({ spot, flip, wall, spotLabel, spotNote, flipLabel, flipNote, wallLabel, wallNote, roomLabel, state }) {
  const w = 280, h = 88, pad = 38;
  const lo = Math.min(flip, spot, wall) - 1.2, hi = Math.max(flip, spot, wall) + 1.2;
